...
const getQuery = `SELECT U.user_ID, U.name, U.email, P.profile_ID, P.description, RR.range, CL.clean_level, RC.room_amount, LC.quadrant, NT.tolerance_level, SH.habits, SS.sleep_type
FROM User AS U
